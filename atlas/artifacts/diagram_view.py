...
def render_html(drawio_xml: str, title: str = "Diagram") -> str:
    """Build the self-contained diagrams.net viewer page for a .drawio XML string."""
...
def write_viewer(drawio_xml: str, out_html: Path, title: str = "Diagram") -> Path:
    ...
    out_html.write_text(render_html(drawio_xml, title), encoding="utf-8")
    return out_html
